"""
Django settings for twilight_wildflower_33 project.
...
ROOT_URLCONF = 'twilight_wildflower_33.urls'
...
WSGI_APPLICATION = 'twilight_wildflower_33.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_wildflower_33 API",
    "DESCRIPTION": "API documentation for twilight_wildflower_33 App",
    "VERSION": "v1",
}
